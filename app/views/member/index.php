          ...
          <div class="card shadow border-0">
            <div class="card-body">
              <div class="row align-items-center">
                ...
                <div class="col pr-0">
                  <p class="small text-muted mb-0">Peminjaman selesai</p>
                  <span class="h3 mb-0"><?= $data['pinjaman_selesai'] ?> Pinjaman</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card shadow border-0">
            <div class="card-body">
              <div class="row align-items-center">
                ...
                <div class="col pr-0">
                  <p class="small text-muted mb-0">Pinjaman Ditolak</p>
                  <span class="h3 mb-0"><?= $data['pinjaman_tolak'] ?> Ditolak</span>
                </div>
              </div>
            </div>
          </div>
