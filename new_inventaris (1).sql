...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 26, 2022 at 04:22 PM
...
(16, 'spm-00001-001', 'sendok', 'apd', 3, 'bandung', '2022-12-22'),
...
(22, '36800-282', 'Stronghold', '0.83', 4, 'AS', '0000-00-00'),
...
(60, 7, '2022-12-20', '2022-12-19', 3, '2022-12-26', NULL, 'Selesai', NULL),
(61, 7, '2022-12-21', '2022-12-21', 3, '2022-12-26', NULL, 'Selesai', NULL),
(62, 24, '2022-12-22', '2022-12-22', 3, '2022-12-25', NULL, 'Diterima', NULL),
(63, 24, '2022-12-22', '2022-12-22', 7, '2022-12-29', NULL, 'Selesai', NULL),
(64, 24, '2022-12-24', '2022-12-26', 3, '2022-12-29', NULL, 'Diterima', NULL),
(65, 24, '2022-12-25', NULL, 7, NULL, NULL, 'Ditolak', 'loba teing'),
(66, 24, '2022-12-25', '2022-12-25', 3, '2022-12-28', NULL, 'Diterima', NULL),
(67, 24, '2022-12-26', NULL, 14, NULL, NULL, 'Ditolak', 'minjem wae'),
(68, 24, '2022-12-26', '2022-12-26', 3, '2022-12-29', NULL, 'Diterima', NULL);
...
(7, 'aji', '$2y$10$ArNq9nVLSCDmuMSvY.lp0eETRusLm4QucFxVilQM18ZJGX19QZbhO', '2', 'aji jr'),
...
--
ALTER TABLE `pinjaman`
  MODIFY `id_pinjaman` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `tb_request_barang`
--
ALTER TABLE `tb_request_barang`
  MODIFY `id_request` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
